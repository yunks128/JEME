...
const GenericResearchDomainsPage = () => {
  ...
  const getDomainColor = (domain) => {
    const colors = {
      ...
      // GRACE domains
      "Terrestrial Water Storage": "bg-blue-100 text-blue-800",
      "Groundwater Depletion": "bg-amber-100 text-amber-800",
      "Ice Mass Balance": "bg-cyan-100 text-cyan-800",
      "Ocean Mass & Sea Level": "bg-indigo-100 text-indigo-800",
      "Gravity Field & Geodesy": "bg-purple-100 text-purple-800",
      "Drought & Flood Detection": "bg-red-100 text-red-800",
      "River Basin Hydrology": "bg-green-100 text-green-800",
      "GRACE Instrument & Methods": "bg-teal-100 text-teal-800",
      // SWOT domains
