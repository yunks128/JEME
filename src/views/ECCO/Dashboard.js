  ...
  return (
    <div className="bg-gray-100 min-h-screen">
      ...
      <main className="max-w-7xl mx-auto px-4 py-6">
        ...
        <MethodologySummary modelName="ECCO" citationsData={eccoData} />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            >
              ...
              <div>
                ...
                <div className="text-sm text-blue-700">All papers citing ECCO team papers</div>
              </div>
        ...
        {eccoData.length > 0 && eccoData[0]?.uncertainty && (
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
            <UncertaintyOverviewCard data={eccoData} modelName="ECCO" />
